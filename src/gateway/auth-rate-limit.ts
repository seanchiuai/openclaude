 ...
 * independent counters for different credential classes while still sharing one
 * limiter instance.
 *
 * Copied from openclaw-source/src/gateway/auth-rate-limit.ts with inlined
 * loopback detection (removes dependency on ./net.js).
 */
...
// ---------------------------------------------------------------------------
// Inlined loopback / IP helpers (replaces ./net.js dependency)
// ---------------------------------------------------------------------------
...
/**
 * Normalize an IP address: strip IPv4-mapped IPv6 prefix and handle
