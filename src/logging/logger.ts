...
let fileReady = false;
let fileWritesEnabled = typeof process.env.VITEST === "undefined";
...
/** Enable or disable file writes (disabled by default in test). */
export function enableFileWrites(enabled: boolean): void {
  fileWritesEnabled = enabled;
}
